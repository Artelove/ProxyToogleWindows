...
if "!ProxyStatus!"=="0" (
    ...
    powershell -command "& {Add-Type -AssemblyName System.Windows.Forms; $form = New-Object System.Windows.Forms.Form; $form.Text = 'Proxy Status'; $form.Size = New-Object System.Drawing.Size(300,200); $form.StartPosition = 'CenterScreen'; $form.TopMost = $true; $label = New-Object System.Windows.Forms.Label; $label.Text = 'Proxy enabled.'; $label.ForeColor = 'Green'; $label.AutoSize = $true; $label.Font = New-Object System.Drawing.Font('Arial', 18); $label.Location = New-Object System.Drawing.Point(50,50); $form.Controls.Add($label); $timer = New-Object System.Windows.Forms.Timer; $timer.Interval = 400; $timer.Add_Tick({$form.Close()}); $timer.Start(); $form.ShowDialog();}"
    echo Proxy enabled.
) else (
    echo Disabling proxy...
    reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings" /v ProxyEnable /t REG_DWORD /d 0 /f
    netsh winhttp reset proxy
    powershell -command "& {Add-Type -AssemblyName System.Windows.Forms; $form = New-Object System.Windows.Forms.Form; $form.Text = 'Proxy Status'; $form.Size = New-Object System.Drawing.Size(300,200); $form.StartPosition = 'CenterScreen'; $form.TopMost = $true; $label = New-Object System.Windows.Forms.Label; $label.Text = 'Proxy disabled.'; $label.ForeColor = 'Red'; $label.AutoSize = $true; $label.Font = New-Object System.Drawing.Font('Arial', 18); $label.Location = New-Object System.Drawing.Point(50,50); $form.Controls.Add($label); $timer = New-Object System.Windows.Forms.Timer; $timer.Interval = 400; $timer.Add_Tick({$form.Close()}); $timer.Start(); $form.ShowDialog();}"
    echo Proxy disabled.
)
